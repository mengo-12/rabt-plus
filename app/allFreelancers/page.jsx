        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                {filtered.length > 0 ? (
                        ...
                        >
                            <div className="flex flex-col items-center text-center">
                                <img
                                    ...
                                    className="w-20 h-20 rounded-full object-cover mb-3 border-4 border-blue-500"
                                />
                                <h2 className="text-lg font-bold text-gray-900 dark:text-white">{freelancer.name}</h2>
                                <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">{freelancer.bio}</p>
                    ...
                    <p className="text-center text-gray-500 dark:text-gray-400 col-span-full">لا يوجد مستقلين مطابقين</p>
                )}
            </div>
        </div>
    )
